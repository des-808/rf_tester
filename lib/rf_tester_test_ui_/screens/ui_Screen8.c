...
void ui_Screen8_screen_init(void)
{
    ...
    ui_ImgButton7 = lv_imagebutton_create(ui_Screen8);
    lv_obj_set_width(ui_ImgButton7, 64);
    lv_obj_set_height(ui_ImgButton7, 64);

    ui_ImgButton11 = lv_imagebutton_create(ui_Screen8);
    lv_obj_set_width(ui_ImgButton11, 64);
    lv_obj_set_height(ui_ImgButton11, 64);
    lv_obj_set_x(ui_ImgButton11, -111);
    lv_obj_set_y(ui_ImgButton11, 175);
